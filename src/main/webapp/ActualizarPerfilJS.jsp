    ...
    <header class="bg-lf-dark text-white p-3 mb-4 rounded-lf-header shadow-sm d-flex justify-content-between align-items-center px-4 px-md-5 flex-shrink-0">
        ...
        <div class="d-flex align-items-center gap-3">
            <div class="text-end d-none d-md-block">
                <div class="fw-bold mb-0" id="headerNombreUsuario" style="font-size: 0.95rem;"><c:out value="${sessionScope.usuario.nombre}" /></div>
    ...
    <div class="row g-4 flex-grow-1 overflow-hidden">
        ...
        <main class="col-12 col-md-8 col-lg-9 h-100 overflow-y-auto pe-2 d-flex justify-content-center align-items-start">
            <div class="perfil-card-container mt-2 w-100 pb-5">
                ...
                <form id="formActualizarPerfil" onsubmit="return false;">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-12">
                            ...
                            <input type="text" id="inputNombre" name="nombre" value="${usuario.nombre != null ? usuario.nombre : ''}" class="form-control form-control-lf" maxlength="50" required>
                        </div>
                        <div class="col-12 col-md-6">
                            <label class="form-label-lf text-muted" style="font-size: 0.85rem;">Apellido Paterno</label>
                            <input type="text" id="inputApellidoPaterno" name="apellidoPaterno" value="${usuario.apellidoPaterno != null ? usuario.apellidoPaterno : ''}" class="form-control form-control-lf" maxlength="50" required>
                        </div>
                        <div class="col-12 col-md-6">
                            <label class="form-label-lf text-muted" style="font-size: 0.85rem;">Apellido Materno</label>
                            <input type="text" id="inputApellidoMaterno" name="apellidoMaterno" value="${usuario.apellidoMaterno != null ? usuario.apellidoMaterno : ''}" class="form-control form-control-lf" maxlength="50">
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="email" name="correo" value="${usuario.correo != null ? usuario.correo : ''}" class="form-control form-control-lf bg-light text-muted" readonly>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label-lf text-muted" style="font-size: 0.85rem;">Teléfono</label>
                            <input type="number" id="inputTelefono" name="telefono" value="${usuario.telefono != null ? usuario.telefono : ''}" class="form-control form-control-lf" oninput="if(this.value.length > 10) this.value = this.value.slice(0, 10);">
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="password" id="inputNuevaContrasena" name="nueva_contrasena" class="form-control form-control-lf" maxlength="100" placeholder="Dejar en blanco para conservar actual">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label-lf text-muted" style="font-size: 0.85rem;">Confirmar contraseña</label>
                            <input type="password" id="inputConfirmarContrasena" name="confirmar_contrasena" class="form-control form-control-lf" maxlength="100" placeholder="Repite la nueva contraseña">
                        </div>
                    </div>

                    <button type="button" id="btnAbrirModal" class="btn btn-action-lf btn-login-style shadow-sm w-100 py-2.5 fs-6 mt-3" disabled>
                        Actualizar
                    </button>
...
<script src="${pageContext.request.contextPath}/assets/js/ActualizarPerfilJS.js"></script>
</body>
</html>