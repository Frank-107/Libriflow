        ...
        <aside class="col-12 col-md-4 col-lg-3">
            <div class="collapse d-md-block" id="sidebarMenu">
                <div class="bg-lf-dark p-4 rounded-lf-sidebar d-flex flex-column gap-3 shadow-sm mb-3 mb-md-0">
                    ...
                    <a href="${pageContext.request.contextPath}/mis-compras" class="btn bg-lf-capsule btn-lf-pill w-100 text-start d-flex align-items-center px-4">
                        <i class="bi bi-bag-check me-3 fs-5"></i>Compras
                    </a>
                    <a href="${pageContext.request.contextPath}/publicar-libro-usuario" class="btn bg-lf-capsule btn-lf-pill w-100 text-start d-flex align-items-center px-4">
                        <i class="bi bi-pencil-square me-3 fs-5"></i>Publicar
                    </a>
                    <a href="${pageContext.request.contextPath}/mis-publicaciones-js" class="btn bg-lf-capsule btn-lf-pill w-100 text-start d-flex align-items-center px-4">
                ...
                <c:choose>
                    <c:when test="${empty publicaciones}">
                        <div class="text-center bg-white rounded-4 shadow-sm p-5 mx-auto" style="max-width:480px;">
                            ...
                            <h4 class="fw-bold mb-2" style="color:#4A4641;">Tu carrito está vacío</h4>
                            <p class="text-muted mb-4">
                                Explora el catálogo y agrega los libros que te interesen — aparecerán aquí listos para que completes tu compra o renta.
                            </p>
                            <a href="${pageContext.request.contextPath}/inicio" class="btn bg-lf-dark text-white btn-lf-pill px-4 py-2 fw-semibold">
                                            ...
                                            <div class="acciones-carrito">
                                                <c:choose>
                                                    <c:when test="${publicacion.esLibriFlow}">
                                                        <a href="${pageContext.request.contextPath}/detalle-informativo?idPublicacion=${publicacion.idPublicacion}&tipo=libriflow&origen=carrito" class="btn-detalles">
                                                            <i class="bi bi-eye"></i>Ver detalles
                                                        </a>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <a href="${pageContext.request.contextPath}/detalle-informativo?idPublicacion=${publicacion.idPublicacion}&tipo=usuario&origen=carrito" class="btn-detalles">
                                                            <i class="bi bi-eye"></i>Ver detalles
                                                        </a>
                                                    </c:otherwise>
                                                </c:choose>
                                                <form action="${pageContext.request.contextPath}/carrito" method="post" class="m-0">
                                    ...
                                    <h4 class="fw-bold">
                                        <c:choose>
                                            <c:when test="${contieneEnvio}">
                                                ...
                                                <br>
                                                Envío: $50-$100
                                                <small class="detalle-envio">(Dependiendo ubicación)</small>
                                            </c:when>
                                            <c:otherwise>
                                                Total: $<c:out value="${subtotal}"/>
                                            </c:otherwise>
                                        </c:choose>
                                    </h4>
                                    <form action="${pageContext.request.contextPath}/carrito" method="post" class="mt-3">
