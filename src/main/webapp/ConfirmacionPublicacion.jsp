<%--
  Vista: ConfirmacionPublicacion.jsp
  Descripción: Vista modal de confirmación enviada al usuario tras registrar un libro.
               Muestra la notificación de éxito y especifica los pasos a seguir para
               la entrega física del ejemplar en las instalaciones de la librería UTEZ.

  Acción / Servlet asociado: /publicar-libro-usuario (POST / Redirección)
  Atributos de Request utilizados:
    - Ninguno / Redirección de confirmación tras procesar el alta.
...
<head>
    ...
    <!-- Estilos y recursos visuales de la notificación -->
...
<div class="overlay-blur" id="pamphletOverlay">
    ...
    <div class="pamphlet-card text-center">
        ...
        <p class="text-muted small mb-4">Ahora sigue estos pasos para completar la entrega de tu libro:</p>
            <%-- Indicaciones secuenciales para la recepción del libro --%>
        <div class="pamphlet-instructions text-start">
            ...
            <!-- Paso 2: Requisitos de identificación -->
            <div class="d-flex align-items-start gap-3">
