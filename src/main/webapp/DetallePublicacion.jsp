                        ...
                        <c:choose>
                            <c:when test="${not empty esAdminPub}">
                                <div class="d-flex flex-column gap-2 w-100">
                                    <form action="detalle-publicacion-admin" method="POST" class="w-100">
    ...
    <div class="modal fade" id="modalRenta" tabindex="-1" aria-labelledby="modalRentaLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content modal-content-lf shadow-lg">
                ...
                <form action="detalle-publicacion-admin" method="POST">
...
<script src="${pageContext.request.contextPath}/assets/js/RentaAdmin.js"></script>
</body>
</html>