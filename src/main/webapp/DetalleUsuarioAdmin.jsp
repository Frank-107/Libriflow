            ...
            <div class="lf-user-details">
                ...
                <div class="lf-user-header">
                    <div>
                        ...
                        <p>Información general y movimientos de la cuenta.</p>
                    </div>
                    ...
                    <div class="lf-user-header-actions">
                        ...
                        <c:choose>
                            <c:when test="${usuario.estado == 'ACTIVA'}">
                                <form action="admin-bloquear-usuario" method="post" class="lf-user-action-form">
                                    <input type="hidden" name="idUsuario" value="${usuario.id}">
                                    <button type="submit" class="lf-user-action-btn lf-block-btn">
                                        <i class="bi bi-lock"></i> Bloquear usuario
                                    </button>
                                </form>
                            </c:when>
                            <c:otherwise>
                                <form action="admin-desbloquear-usuario" method="post" class="lf-user-action-form">
                                    <input type="hidden" name="idUsuario" value="${usuario.id}">
                                    <button type="submit" class="lf-user-action-btn lf-unblock-btn">
                ...
                <div class="lf-user-info-card">
                    <div class="lf-card-title">
                        ...
                        <div>
                            ...
                            <p>Datos básicos de la cuenta</p>
                        </div>
                    </div>
                ...
                <div class="lf-user-info-card">
                    <div class="lf-card-title">
                        ...
                        <div>
                            ...
                            <p>Actividad actual del usuario</p>
                        </div>
                    </div>
                                                ...
                                                <c:choose>
                                                    <c:when test="${mov.tipoMovimiento == 'COMPRA'}">
                                                            <span class="lf-movement-type lf-movement-buy">
                                                                <i class="bi bi-cart-check"></i> Compra
                                                            </span>
                                                    </c:when>
                                                    ...
                                                    <c:when test="${mov.tipoMovimiento == 'RENTA'}">
                                                            <span class="lf-movement-type lf-movement-rent">
                                                                <i class="bi bi-arrow-repeat"></i> Renta
                                                            </span>
                                                    </c:when>
                                                    <c:otherwise>
                                                ...
                                                <c:choose>
                                                    <c:when test="${mov.esLibriFlow}">
                                                            <span class="lf-origin lf-origin-libriflow">
                                                                <i class="bi bi-book"></i> LibriFlow
                                                            </span>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <span class="lf-origin lf-origin-user">Usuario</span>
                                                    </c:otherwise>
                                                </c:choose>
                                            </td>
                                        </tr>
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            <div class="lf-empty-movements">
                                                ...
                                                <span>Este usuario todavía no tiene movimientos registrados.</span>
                                            </div>
                                        </td>
                                    </tr>
                                </c:otherwise>
