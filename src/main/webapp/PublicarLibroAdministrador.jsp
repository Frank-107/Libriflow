...
<head>
    ...
    <title>Publicar Libro Admin - LibriFlow</title>
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 dropdown-menu-lf">
                    <li>
                        <a class="dropdown-item py-2 dropdown-lf-item" href="actualizar-perfil-admin">
        ...
        <main class="col-12 col-md-8 col-lg-9 catalogo-scroll">
            <div class="form-container-lf p-4 p-md-5 shadow-sm bg-white">
                ...
                <div class="d-flex justify-content-between align-items-start mb-4 flex-wrap gap-3">
                    ...
                    <div class="text-end">
                        <img src="${pageContext.request.contextPath}/assets/img/LogoLibriflowF.png" alt="LibriFlow" style="height: 35px; width: auto;">
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            ...
                            <div class="form-control form-control-lf d-flex align-items-center justify-content-around">
                                <div class="form-check form-check-inline mb-0">
                                    <input class="form-check-input" type="checkbox" id="checkVenta" name="esVenta" value="1" ${param.esVenta == '1' ? 'checked' : ''}>
                                    <label class="form-check-label" for="checkVenta">Venta</label>
                                </div>
                                <div class="form-check form-check-inline mb-0">
                                    <input class="form-check-input" type="checkbox" id="checkRenta" name="esRenta" value="1" ${param.esRenta == '1' ? 'checked' : ''}>
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            ...
                            <input type="number"
                                   id="cantidad"
                                   name="cantidad"
                                   value="<c:out value='${param.cantidad}' escapeXml='true'/>"
                                   class="form-control form-control-lf"
                                   min="1"
                                   max="999"
                                   placeholder="Ej: 5"
