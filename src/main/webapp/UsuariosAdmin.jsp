...
<head>
    ...
    <!-- Estilos globales de LibriFlow y CSS exclusivo de Usuarios -->
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/assets/css/LibriFlow.css"/>

    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/assets/css/UsuariosAdmin.css"/>
</head>
    ...
    <div class="row g-4">
        ...
        <main class="col d-flex flex-column h-100 min-vh-0">
            ...
            <section class="usuarios-container d-flex flex-column h-100">
                ...
                <div class="usuarios-header flex-shrink-0">

                    <h2>
                        Lista de usuarios (<c:out value="${usuarios.size()}" />)
                    </h2>
                    ...
                    <c:when test="${empty usuarios}">
                        ...
                        <div class="sin-usuarios text-center bg-white rounded-4 shadow-sm p-5 mx-auto"
                            ...
                            <p class="text-muted mb-0">
                                Cuando se registren nuevos usuarios en la plataforma,
                                        ...
                                        <c:if test="${u.correo != 'adminLibri@utez.edu.mx' && u.id != sessionScope.usuario.id}">
                                            ...
                                            <tr>
                                                ...
                                                <td class="fw-semibold text-dark">
                                                    ...
                                                    <c:out value="${u.apellidoPaterno}" />
                                                    <c:out value="${u.apellidoMaterno}" />
                                                </td>

                                                <td>
                                                    <c:out value="${u.correo}" />
                                                </td>

                                                <td>
                                                    <c:out value="${empty u.telefono ? 'N/A' : u.telefono}" />
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${u.estado == 'ACTIVA' || u.estado == 'ACTIVO'}">
                                                            ...
                                                            <span class="badge badge-usuario badge-activa">
                                                                ACTIVO
                                                            </span>
                                                        ...
                                                        <c:otherwise>
                                                            ...
                                                            <span class="badge badge-usuario badge-bloqueado">
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="detalle-usuario-admin?idUsuario=${u.id}"
                                                       class="btn bg-lf-capsule btn-lf-pill text-dark btn-sm px-3 shadow-sm btn-ver-detalles">
